...
export const ARTICLE_SOURCE_SLUGS = Object.freeze([
  ...
  "day-care-activity-refusal-choice",
  "community-care-accessibility-walkthrough",
  "reablement-first-visit-life-goals",
  "migrant-care-plan-change-handover",
  "long-term-care-training-feedback-note",
  "long-term-care-required-field-check",
  "home-care-belongings-privacy-agreement",
  "day-care-quiet-space-support",
  ...
  "ba04-feeding-tube-feeding-support-guide",
  "ba05-meal-preparation-care-guide",
  "ba07-bathing-shampoo-assistance-guide"
]);
