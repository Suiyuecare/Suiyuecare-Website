...
values
  ('site-assets', 'assets/homepage-batch/05-orange-polo-caregiver.png', '/assets/homepage-batch/05-orange-polo-caregiver.png', '05-orange-polo-caregiver.png', 'image/png', '照服員核心訓練課程封面', 'public', true, 'article_cover', 'center'),
  ('site-assets', 'assets/homepage-batch/12-community-health-class.png', '/assets/homepage-batch/12-community-health-class.png', '12-community-health-class.png', 'image/png', '家庭照顧者實用課封面', 'public', true, 'article_cover', 'center'),
  ('site-assets', 'assets/homepage-batch/19-health-dementia-cover.png', '/assets/homepage-batch/19-health-dementia-cover.png', '19-health-dementia-cover.png', 'image/png', '失智照顧溝通工作坊封面', 'public', true, 'article_cover', 'center'),
  ('site-assets', 'assets/homepage-batch/03-supervisor-care-plan.png', '/assets/homepage-batch/03-supervisor-care-plan.png', '03-supervisor-care-plan.png', 'image/png', '移工照顧技能培訓封面', 'public', true, 'article_cover', 'center'),
  ('site-assets', 'assets/homepage-batch/04-admin-team-office.png', '/assets/homepage-batch/04-admin-team-office.png', '04-admin-team-office.png', 'image/png', '督導品質管理研習封面', 'public', true, 'article_cover', 'center'),
  ('site-assets', 'assets/homepage-batch/13-rehab-walking-practice.png', '/assets/homepage-batch/13-rehab-walking-practice.png', '13-rehab-walking-practice.png', 'image/png', '護理復能基礎課封面', 'public', true, 'article_cover', 'center')
