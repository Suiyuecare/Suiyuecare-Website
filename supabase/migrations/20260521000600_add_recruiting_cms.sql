...
values
  ('site-assets', 'assets/recruit-home-care-worker.png', '/assets/recruit-home-care-worker.png', 'recruit-home-care-worker.png', 'image/png', '居家照顧服務員招募形象照', 'public', true, 'card', 'center'),
  ('site-assets', 'assets/recruit-home-care-supervisor.png', '/assets/recruit-home-care-supervisor.png', 'recruit-home-care-supervisor.png', 'image/png', '居家服務督導招募形象照', 'public', true, 'card', 'center'),
  ('site-assets', 'assets/daycare-recruit-02-exercise.png', '/assets/daycare-recruit-02-exercise.png', 'daycare-recruit-02-exercise.png', 'image/png', '日照照顧服務員帶領活動招募形象照', 'public', true, 'card', 'center'),
  ('site-assets', 'assets/migrant-recruit-01-classroom.png', '/assets/migrant-recruit-01-classroom.png', 'migrant-recruit-01-classroom.png', 'image/png', '移工培訓課堂招募形象照', 'public', true, 'card', 'center'),
  ('site-assets', 'assets/quality-recruit-04-quality-meeting.png', '/assets/quality-recruit-04-quality-meeting.png', 'quality-recruit-04-quality-meeting.png', 'image/png', '教育品管品質會議招募形象照', 'public', true, 'card', 'center'),
  ('site-assets', 'assets/admin-recruit-05-meeting.png', '/assets/admin-recruit-05-meeting.png', 'admin-recruit-05-meeting.png', 'image/png', '行政部跨部門會議招募形象照', 'public', true, 'card', 'center'),
  ('site-assets', 'assets/homepage-batch/04-admin-team-office.png', '/assets/homepage-batch/04-admin-team-office.png', '04-admin-team-office.png', 'image/png', '歲悅長照營運與合作會議', 'public', true, 'service_hero', 'center'),
  ('site-assets', 'assets/homepage-batch/16-taipei-service-office.png', '/assets/homepage-batch/16-taipei-service-office.png', '16-taipei-service-office.png', 'image/png', '長照服務場域與辦公空間', 'public', true, 'service_hero', 'center')
...
values
  (
    ...
    (select id from public.media where storage_path = 'assets/recruit-home-care-worker.png'), '/assets/recruit-home-care-worker.png',
  ...
  (
    ...
    (select id from public.media where storage_path = 'assets/homepage-batch/16-taipei-service-office.png'), '/assets/homepage-batch/16-taipei-service-office.png',
  ...
  (
    ...
    (select id from public.media where storage_path = 'assets/homepage-batch/04-admin-team-office.png'), '/assets/homepage-batch/04-admin-team-office.png',
...
values
  ('talent', 'home-care-team', 'Home Care Team', '居家照顧部門', '最靠近家庭的一線服務，把身體照顧、生活支持、家屬溝通與服務紀錄串成穩定流程。', (select id from public.media where storage_path = 'assets/recruit-home-care-worker.png'), '/assets/recruit-home-care-worker.png', '["到宅服務","督導陪跑","家屬溝通"]'::jsonb, '[{"image":"/assets/recruit-home-care-worker.png","caption":"居家照顧服務員到宅服務"},{"image":"/assets/recruit-home-care-supervisor.png","caption":"督導陪同討論照顧計畫"}]'::jsonb, '{}'::jsonb, 10, true, 'published', now()),
  ('talent', 'day-care-team', 'Day Care Team', '日間照顧部', '讓長輩白天有安全、有活動、有同伴，也讓家庭有喘息空間。', (select id from public.media where storage_path = 'assets/daycare-recruit-02-exercise.png'), '/assets/daycare-recruit-02-exercise.png', '["活動陪伴","餐食照顧","日常紀錄"]'::jsonb, '[{"image":"/assets/daycare-recruit-02-exercise.png","caption":"帶領團體活動"},{"image":"/assets/daycare-recruit-03-meal.png","caption":"餐食與營養支持"}]'::jsonb, '{}'::jsonb, 20, true, 'published', now()),
  ('talent', 'migrant-team', 'Migrant Training', '移工培訓部', '把家庭照顧技能整理成可聽懂、可練習、回家能執行的課程。', (select id from public.media where storage_path = 'assets/migrant-recruit-01-classroom.png'), '/assets/migrant-recruit-01-classroom.png', '["情境課程","安全移位","家庭溝通"]'::jsonb, '[{"image":"/assets/migrant-recruit-01-classroom.png","caption":"移工培訓課堂"},{"image":"/assets/migrant-recruit-02-transfer.png","caption":"安全移位練習"}]'::jsonb, '{}'::jsonb, 30, true, 'published', now()),
  ('talent', 'quality-team', 'Teaching Quality', '教學品管部', '把前線照顧經驗變成可學習、可檢核、可改善的制度。', (select id from public.media where storage_path = 'assets/quality-recruit-04-quality-meeting.png'), '/assets/quality-recruit-04-quality-meeting.png', '["教材設計","紀錄檢核","品質改善"]'::jsonb, '[{"image":"/assets/quality-recruit-04-quality-meeting.png","caption":"品質改善會議"},{"image":"/assets/quality-recruit-03-record-review.png","caption":"服務紀錄檢核"}]'::jsonb, '{}'::jsonb, 40, true, 'published', now()),
  ('talent', 'admin-team', 'Administration', '行政部', '支援招募、營運調度、財務行政、客服總務與跨部門專案。', (select id from public.media where storage_path = 'assets/admin-recruit-05-meeting.png'), '/assets/admin-recruit-05-meeting.png', '["營運支援","資料管理","跨部門協作"]'::jsonb, '[{"image":"/assets/admin-recruit-05-meeting.png","caption":"跨部門會議"},{"image":"/assets/admin-recruit-02-operations.png","caption":"營運調度支援"}]'::jsonb, '{}'::jsonb, 50, true, 'published', now()),
  ('land', 'site-evaluation', 'Site Evaluation', '場域條件評估', '針對土地、建物、樓層、坪數、動線與周邊服務需求進行初步評估。', (select id from public.media where storage_path = 'assets/homepage-batch/16-taipei-service-office.png'), '/assets/homepage-batch/16-taipei-service-office.png', '["基地條件","服務半徑","合作模式"]'::jsonb, '[]'::jsonb, '{}'::jsonb, 10, true, 'published', now()),
  ('investor-recruiting', 'investment-partnership', 'Investment Partnership', '投資合作洽談', '提供公司簡介、展店模型、營運進度與合作架構說明。', (select id from public.media where storage_path = 'assets/homepage-batch/04-admin-team-office.png'), '/assets/homepage-batch/04-admin-team-office.png', '["展店模型","營運數據","合作治理"]'::jsonb, '[]'::jsonb, '{}'::jsonb, 10, true, 'published', now())
