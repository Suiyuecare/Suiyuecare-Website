...
values
  ...
  ('home', 'recruit', 'home-care-worker', '居家照顧服務員', null, 'We want you', '到宅陪伴、生活支持、照顧紀錄。', null, '居家照顧部門', '立即應徵', '#talent', (select id from public.media where storage_path = 'assets/homepage-batch/05-orange-polo-caregiver.png'), 10, true, true, 'published', now(), '{}'::jsonb),
  ('home', 'recruit', 'home-care-supervisor', '居家服務督導', null, 'We want you', '照顧品質追蹤、服務媒合與團隊支持。', null, '居家照顧部門', '立即應徵', '#talent', (select id from public.media where storage_path = 'assets/homepage-batch/06-orange-polo-supervisor.png'), 20, false, true, 'published', now(), '{}'::jsonb),
  ('home', 'recruit', 'daycare-worker', '日照照顧服務員', null, 'We want you', '活動陪伴、餐食照顧、長輩日常支持。', null, '日間照顧部', '立即應徵', '#talent', (select id from public.media where storage_path = 'assets/homepage-batch/04-admin-team-office.png'), 30, false, true, 'published', now(), '{}'::jsonb),
  ('home', 'video', 'main-unit-video', '單位影片', 'Suiyuecare Corps. 單位影片', 'Video', 'https://www.youtube.com/embed/dQw4w9WgXcQ', null, 'YouTube', '觀看影片', 'https://www.youtube.com/embed/dQw4w9WgXcQ', null, 10, true, true, 'published', now(), '{"provider":"youtube"}'::jsonb),
  ('home', 'care_story', 'lin-home-care', '「爸爸出院後，我終於知道每天該注意什麼。」', '林小姐', 'Care Stories', '稱讚歲悅的每日回報很清楚，從安全移位、用餐狀態到精神狀況都會主動說明，家人不用一直猜。', null, '居家照顧', 'Read More', '#article-family-care-story', (select id from public.media where storage_path = 'assets/homepage-batch/05-orange-polo-caregiver.png'), 10, true, true, 'published', now(), '{}'::jsonb),
  ('home', 'care_story', 'chen-day-care', '「媽媽白天有人陪，晚上還能回家睡。」', '陳小姐', 'Care Stories', '稱讚日照活動安排有節奏，餐食與休息都被照顧到，媽媽比較有精神，家屬上班也放心。', null, '日間照顧', 'Read More', '#article-family-care-story', (select id from public.media where storage_path = 'assets/homepage-batch/02-daycare-group-exercise.png'), 20, false, true, 'published', now(), '{}'::jsonb),
  ('home', 'master_talk', 'care-psychology-chou', '好的照顧，是讓長輩和家屬都保有生活感。', '照顧心理講師 周小姐', 'Master Talk', '她分享家屬在照顧初期最需要的是可理解的資訊與可求助的系統。', null, '名人講堂', 'Read More', '#article-master-talk-care-psychology', (select id from public.media where storage_path = 'assets/homepage-batch/10-family-consultation.png'), 10, true, true, 'published', now(), '{}'::jsonb)
