...
function renderMilestonesPage() {
  ...
  const timeline = [
    ...
    ["2025", "12", "第一版官方網站上線", "上線", "第一版官方網站完成上線，建立品牌資訊、服務介紹與聯絡入口，讓家庭能更快了解歲悅服務。", "/assets/milestones/project-management-module.jpg", "已完成"],
    ...
    ["2026", "06", "第二版官方網站上線", "上線", "第二版官方網站完成上線，優化服務動線、內容架構與視覺呈現，讓使用者更清楚找到所需資訊。", "/assets/milestones/e-seal-module.jpg", "已完成"],
