...
健康3.0與照顧知識文章的必要規範：
- 參考資料必須先查 PubMed；不得捏造 PMID、DOI、作者、期刊或年份。
- 參考資料呈現時只使用「參考資料」，不要寫「延伸閱讀」。
- Citation 使用 APA 7th 格式，連結需能直達對應 PubMed 頁面。
- 同一篇文章內同一 reference 不可重複出現。
- 證據力排序由強到弱：系統性文獻回顧/統合分析、RCT、世代研究/病例對照研究、專家意見/個案報告/動物或體外研究、新聞或一般網站。健康3.0文章不可用新聞或一般網站作為主要證據。
- 每篇文章需規劃一張全新主圖與 1-2 張全新內文補充圖，不可沿用舊圖；若本次資料未提供圖，請在內容中避免宣稱已附圖。
